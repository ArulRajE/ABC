...
$result = pg_query($db, 'select * from (select * from "stCount2011"
LEFT JOIN forreaddata2021
On "stCount2011"."STID2011" = forreaddata2021."frfromids" 
) data2011   
INNER JOIN "forreadst2021"  
ON data2011."frtoids"="forreadst2021"."STID" ORDER BY data2011."STID2011",data2011."frids" ASC');
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title mb-4"><span class="dropcap text-primary">State wise</span>
                            ...
                            <table id="units-datatable" class="table table-hover table-striped table-bordered"
                                ...
                                <thead>
                                    <tr>
                                        <th colspan="2" style="background-color: #fe6271; color: #FFFFFF">For - <?php echo $_SESSION['logindetails']['baseyear']; ?></th>
                                        <th colspan="3" style="background-color: #15bed2; color: #FFFFFF ">
