                            ...
                            <div id="progressbarwizard1">
                                ...
                                <div class="tab-content b-0 mb-0">
                                    ...
                                    <div class="tab-pane" id="account-2">
                                        <div class="row">
                                            <div class="col-6">
                                                <form enctype="multipart/form-data" class="form-horizontal group-border-dashed" data-parsley-validate novalidate data-parsley-trigger="keyup" id="adddocument">
                                                    ...
                                                    <!-- Ends... -->
                                                    <input type="hidden" name="doctype" id="doctype" value="<?php if (isset($_GET['doctype'])) {
                                                                                                                echo $_GET['doctype'];
                                                                                                            }  ?>">
                                                    <fieldset class="let">
                                                        ...
                                                        <div class="form-group row mb-3">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select <?php if ($_GET['come'] == 'comefromdocadd') { ?> disabled <?php } ?> data-toggle="select2" id="selectdocumnent" name="selectdocumnent" onchange="return getselecteddocument(this.value,'');">
                                                    ...
                                                    <div class="row">
                                                        <label class="col-md-12 col-form-label text-center" for="userName1">
                                                            <h4>Or</h4>
                                                        </label>
                                                    ...
                                                    <fieldset class="let">
                                                        ...
                                                        <div class="form-group row mb-3">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="file" onchange="PreviewImage1();" required="required" id="adddocnotification" name="adddocnotification" accept="application/pdf" class="dropify" />
                                                            </div>
                                                        </div>
                                            ...
                                            <option value="Others">Others</option>
                                                                ...
                                                                <!-- adddocument type -->
                                                                <select required="required" id="adddoctype" <?php if ($_GET['come'] == 'comefromdocadd') { ?> disabled <?php } ?> name="adddoctype" onchange="return get_doctype_data(this,'<?php echo $_GET['come']; ?>');">
                                                                    <option value="">Select Type</option>
                                                                    <option value="Notification">Notification</option>
                                                        ...
                                                        <div class="otherrmk" style="display: none;">
                                                            <div class="form-group row mb-3">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <textarea class="form-control otherrmk" data-parsley-pattern="^[a-zA-Z\s]+$" data-parsley-pattern-message="Input text can contain only alphabets and spaces." placeholder="Specify the Type" rows="4" id="otherremarks" name="otherremarks"></textarea>
                                                                </div>
                                                ...
                                                data-date-autoclose="true" autocomplete="false">
                                                        ...
                                                        <div class="form-group row mb-3">
                                                            ...
                                                            <div class="col-md-9">
                                                                ...
                                                                <input type="text" class="form-control datepicker" placeholder="dd-mm-yyyy" data-provide="datepicker" id="adddocdate" name="adddocdate" required="required" data-date-autoclose="true" autocomplete="off" onchange="return get_dist_select_data(this,'<?php echo $passvalue; ?>');">
                                                                <!-- <?php if ($_GET['come'] == 'comefromdocadd') {
                                                                            echo 'value="' . $yourDesiredDate . '"';
                                                                        } ?>> -->
                                                                <?php if ($_GET['come'] == 'comefromdocadd')  ?>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row mb-3">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" name="adddoctitle" id="adddoctitle" required placeholder="Document No." data-parsley-pattern="^[^<>;]+$" data-parsley-pattern-message="'< >' OR ';' value seems to be invalid." data-parsley-minlength="2" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group row mb-3">
                                                            ...
                                                            <div class="col-md-9">
                                                                ...
                                                                <select id="adddockeydes" name="adddockeydes" required="" onchange="return get_dist_select_data(this,'<?php echo $passvalue; ?>');">
                                    ...
                                    <div class="tab-pane" id="profile-tab-2">
                                        <div class="row">
                                            ...
                                            <div class="col-7">
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="col-md-12 row">
                                                                ...
                                                                <div class="col-sm-12 col-md-6 col-lg-6 pl-0 pt-2 col-xl-4">
                                                                    ...
                                                                    <button type="button" onclick="submerge('submerge', 1)" name="mergenew" class="btn btn-primary btn-rounded waves-effect waves-light width-xl disbut" id="submerge">Sub-Merge</button>
                                                ...
                                                <form enctype="multipart/form-data" class="form-horizontal group-border-dashed" data-parsley-validate novalidate data-parsley-trigger="keyup" id="adddocumentnext">
  ...
  <input type="hidden" name="dtselected" id="dtselected" value="">
    <input type="hidden" name="sdidsselected" id="sdidsselected" value=""> -->
                                    ...
                                    <div class="tab-pane" id="finish-2">
                                        <form enctype="multipart/form-data" class="form-horizontal group-border-dashed" data-parsley-validate novalidate data-parsley-trigger="keyup" id="finalsubmitdocumentdata">
    ...
    $(document).ready(function() {
        ...
        $('input[type="radio"]').click(function() {
            ...
            <?php if (isset($_GET) && $_GET['ids'] != '') { ?>
                ...
                // $('#selectdocumnent').val(<?php //echo $_GET['idsdoc']; 
                                                ?>).trigger('change');
            <?php } else if (isset($_GET) && $_GET['idsdoc'] != '') { ?>
                $('#Mergebt').prop('disabled', false);
                $('#Partiallysm').prop('disabled', true);
...
<script type="text/javascript">
    $(function() {
        ...
        // optionstate +=
        //     '<option value = "<?php  //echo $valueof; 
                                    ?>"><?php  //echo $valueofname; 
                                                                ?></option>';
        // <?php  // } 
            ?>
        ...
        // <?php  //foreach ($rowaction as $key => $element) { 
            ?>
        // optionaction +=
        //     '<option value = "<?php  //echo $element['statuslevel']; 
                                    ?>"><?php  //echo $element['forreaddetails']; 
                                                                            ?></option>';
        // <?php // } 
            ?>
        ...
        $(addButton1).click(function() {
            ...
            if (x1 < maxField1) {
                ...
                var subfieldHTML =
                    '<div id="ststatussub' + x1 + '">' +
                        '<div class="form-group row">' +
                            '<label class="col-md-3 col-form-label">Select State / UT</label>' +
                            '<div class="col-md-9 pt-2">' +
                                '<select id="stategetsub' + x1 + '" onchange="return get_district_popup_list_ii(this, '+x1+');" name="stategetsub[]"></select>' +
                            '</div>' +
                        '</div>' +
                    '</div>' +

                    '<div id="districtstatussub' + x1 + '">' +
                        '<div class="form-group row">' +
                            '<label class="col-md-3 col-form-label">Select District</label>' +
                            '<div class="col-md-9 pt-2">' +
                                '<select id="districtgetsub' + x1 + '" onchange="return get_district_popup_sublist_ii(this, '+x1+');" name="districtgetsub[]"></select>' +
                            '</div>' +
                        '</div>' +
                    '</div>' +

                    '<div" id="subdistrictstatussub' + x1 + '">' +
                        '<div class="form-group row">' +
                            '<label class="col-md-3 col-form-label">Select Sub-District</label>' +
                            '<div class="col-md-9 pt-2">' +
                                '<select id="subdistrictgetsub' + x1 + '" onchange="return get_sub_district_popup_list_ii(this, '+x1+');" name="subdistrictgetsub[]">' +
                                    '<option value="">Select Sub-District</option>' +
                                '</select>' +
                            '</div>' +
                        '</div>' +
                    '</div>'+
                    '<fieldset class="let" id="let">' +
                        '<legend class="chha">Action On <span id="comespan"></span></legend>' +
                            '<div id="adddataofsub">' +
                                '<div class="form-group row">' +
                                    '<div class="col-md-2 pt-2">' +
                                        '<label id="addlablesub1"></label>' +
                                    "</div>" +
                                '<div id="comefromdata123' + x1 + '"></div>' +
                ...
                $.ajax({
                    ...
                    if (finalresult[8] != 'null') {
                        if (clickpopup == 'Rename' && seleted == 'State') {
                        ...
                        } else if(seleted == 'Village / Town' && clickpopup == 'submerge'){
                            $("#stategetsub" + x1 + "").children().remove();
                            $("#stategetsub" + x1 + "").append($('<option>', {
                            value: '',
                            text: 'Select State / UT',
                            }));
                            ...
                            if(stateid != ''){
                                $('#stategetsub' + x1 + "").val(stateid).trigger('change');
                            }
                            
                            else {
                                var jsonresult = JSON.parse(finalresult[0]);
                                var result = jsonresult[0];
                                $('#stategetsub' + x1 + "").val(result.id).trigger('change');
