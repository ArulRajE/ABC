        ...
        <div id="srow_${x2}">
            <div id="ststatussub${x2}">
                <div class="form-group row">
                    ...
                    <div class="col-md-9 pt-2">
                        <select id="stategetsub${x2}" onchange="return get_district_popup_list_ii(this, ${x2});" name="stategetsub${x2}[]"></select>
                    </div>
                </div>
            </div>
            ...
            <div style="display: none;" id="districtstatussub${x2}">
                <div class="form-group row">
                    ...
                    <div class="col-md-9 pt-2">
                        <select id="districtgetsub${x2}" onchange="return get_district_popup_sublist_ii(this, ${x2});" name="districtgetsub${x2}[]"></select>
                    </div>
                </div>
            </div>
            ...
            <div style="display: none;" id="subdistrictstatussub${x2}">
                <div class="form-group row">
                    ...
                    <div class="col-md-9 pt-2">
                        <select id="subdistrictgetsub${x2}" onchange="return get_sub_district_popup_list_ii(this, ${x2});" name="subdistrictgetsub${x2}[]">
