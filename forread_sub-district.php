...
$result = pg_query($db, 'select * from (select * from "sdCount2011"
LEFT JOIN forreaddata2021
On "sdCount2011"."SDID2011" = forreaddata2021."frfromids"
) data2011  
INNER JOIN "forreadsd2021"  
ON data2011."frtoids"="forreadsd2021"."SDID" ORDER BY data2011."SDID2011",data2011."frids" ASC');
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title mb-4"><span class="dropcap text-primary">Sub-District wise</span>
                            ...
                            <table id="units-datatable" class="table table-hover table-striped table-bordered"
                                ...
                                <thead>
                                    <tr>
                                        <th colspan="6" style="background-color: #fe6271; color: #FFFFFF">For - <?php echo $_SESSION['logindetails']['baseyear']; ?></th>
