...
$result = pg_query($db, 'select * from (select * from "vtCount2011"
LEFT JOIN forreaddata2021
On "vtCount2011"."VTID2011" = forreaddata2021."frfromids"
) data2011  
INNER JOIN "forreadvt2021"  
ON data2011."frtoids"="forreadvt2021"."VTID" ORDER BY data2011."VTID2011",data2011."frids" ASC');
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title mb-4"><span class="dropcap text-primary">Viilage / Town wise</span>
                            ...
                            <table id="units-datatable" class="table table-hover table-striped table-bordered"
                                ...
                                <thead>
                                    <tr>
                                        <th colspan="8" style="background-color: #fe6271; color: #FFFFFF">For - <?php echo $_SESSION['logindetails']['baseyear']; ?></th>
                                        <th colspan="9" style="background-color: #15bed2; color: #FFFFFF ">
                                    ...
                                    <tr>
                                        ...
                                        <th>District MDDS</th>
                                        <th>District Name</th>
                                        <th>Sub-District MDDS</th>
                                        <th>Sub-District Name</th>
                                        <th>Village / Town MDDS</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $data['MDDS_SD'.$_SESSION['logindetails']['baseyear'].'']; ?></td>
                                        <td><?php echo $data['SDName'.$_SESSION['logindetails']['baseyear'].'']; ?></td>
                                        <td><?php echo $data['MDDS_VT'.$_SESSION['logindetails']['baseyear'].'']; ?></td>
                                        <td><?php echo $data['VTName'.$_SESSION['logindetails']['baseyear'].'']; ?></td>
                                        ...
                                        <td class="class2021"><?php echo $data['MDDS_SD']; ?></td>
                                        <td class="class2021"><?php echo $data['SDName']; ?></td>
                                        <td class="class2021"><?php echo $data['MDDS_VT']; ?></td>
