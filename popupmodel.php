                    ...
                    <div id="addnewdocument" class="modal fade bs-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" data-keyboard="false" data-backdrop="static" aria-hidden="true">

                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <form class="form-horizontal group-border-dashed" data-parsley-validate novalidate data-parsley-trigger="keyup" id="assigndata">
                                            ...
                                            <div class="col-xl-12">
                                                <div>
                                                    ...
                                                    <fieldset class="let" id="let" style="display: none;">
                                                        <legend class="chha lablefrom">Action From <?php echo $_SESSION['logindetails']['baseyear']; ?> - <?php echo $_SESSION['activeyears']; ?></legend>
                                                        ...
                                                        <div id="adddataof">
                                                            ...
                                                            <div class="row" id="row_1">
                                                                ...
                                                                <div class="form-group col-md-3 fromstate ST pl-1 pr-1" style="display:none;">
                                                                    <label style="display:none;" class="col-md-12 fromstate pl-1 pr-1">Select State / UT</label>
                                                                    <div style="display:none;" class="col-md-12 fromstate pl-1 pr-1">
                                                                        <select id="fromstate1" onchange="return get_district_popup_distdata(this,'Create');" name="fromstate[]" class="fromstate">
                                                                ...
                                                                <div class="form-group col-md-3 districtstatus DT pl-1 pr-1" style="display:none;">
                                                                    <label style="display:none;" id="districtstatus" class="col-md-12 pl-1 pr-1">Select District</label>
                                                                    <div style="display:none;" id="districtstatusdrop" class="col-md-12 pl-1 pr-1">
                                                                        <select id="districtget" onchange="return get_district_popup(this,'Create');" name="districtget[]">
                                                                ...
                                                                <div class="form-group col-md-3 sddistrictstatus SD1 pl-1 pr-1" style="display:none;">
                                                                    <label style="display:none;" id="sddistrictstatus" class="col-md-12 pl-1 pr-1 sddistrictstatus">Select Sub-District</label>
                                                                    <div style="display:none;" id="sddistrictstatusdrop" class="col-md-12 pl-1 pr-1 sddistrictstatus">
                                                                        <select id="sddistrictget_1" class="sddistrictstatus" onchange="return get_sub_district_popup_new(this,'Create',1);" name="sddistrictget[]">
                                                                            <option value="">Select Sub-District</option>
                                                                        </select>
                                                                ...
                                                                <div class="form-group col-md-3 SD pl-1 pr-1">
                                                                    ...
                                                                    <div class="col-md-12 pl-1 pr-1" id="comefromdata">
                                                                        ...
                                                                        <select class="form-select  mainvaldata" required name="namefrom[]" id="selected_come" onchange="return get_fromvalue1(this.value,1)"></select>
                                                                    </div>
                                                                ...
                                                                <div class="form-group col-md-3 AC pl-1 pr-1">
                                                                    ...
                                                                    <div class="col-md-12 pl-1 pr-1">
                                                                        <select class="form-select actiondata" required onchange="return getdata_action(this,1);" name="action[]" id="action1">
                                                                ...
                                                                <div class="form-group col-md-3 FAC pl-1 pr-1" style="display:none">
                                                                    <div class="col-md-12 pl-1 pr-1">
                                                                        <label> New Status of <?php echo $_SESSION['activeyears']; ?> </label>
                                                                    </div>
                                                                    <div class="col-md-12 pl-1 pr-1">
                                                        ...
                                                        <div class="col-md-2 mt-1" id="addbtu">
                                                            <button type="button" disabled class="btn btn-primary btn-rounded waves-effect waves-light add_button">
                                                    ...
                                                    <!-- </div> -->
                                                    <fieldset class="let">
                                                        <legend class="chha">Action On <?php echo $_SESSION['activeyears']; ?> <span id="comespan"></span></legend>
                                                        ...
                                                        <div class="row" id="todataaction_1">
                                                            ...
                                                            <div class="form-group col-md-3 dtnew DT pl-1 pr-1" style="display:none">
                                                                ...
                                                                <div class="col-md-12 pl-1 pr-1 dtnew" id="dtnewdrop">
                                                                    <select id="districtnew1" class="dtnew" onchange="return get_sddistrict_popupto(this,'Create');" name="districtnew[]">
                                                                        <option value="">Select District</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="form-group col-md-3 sdnew SD1 pl-1 pr-1" style="display:none">
                                                                <label class="col-md-12 sdnew pl-1 pr-1" id="sdnew">Select Sub-District</label>
                                                                <div class="col-md-12 pl-1 pr-1 sdnew" id="sdnewdrop">
                                                                    <select id="sddistrictnew1" onchange="return getvtlist(this,1);" name="sddistrictnew[]" class="sdnew">
                                                                        <option value="">Select Sub-District</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group col-md-3 SD pl-1 pr-1">
                                                                ...
                                                                <div class="col-md-12 pl-1 pr-1 newname">
                                                                    ...
                                                                    <input type="text" data-parsley-minlength="2" data-parsley-pattern="^[^<>;]+$" data-parsley-pattern-message="'<' OR '>' value seems to be invalid." class="form-control newname" name="newname[]" id="name2021" required />
                                                                </div>
                                                                <div class="col-md-12 pl-1 pr-1 newnamem">


                                                                    <select id="named2021" name="newnamem[]" class="newnamem" onchange="return get_to_data(this,'');">
                                                                        <option value="">Select State / UT</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="form-group col-md-3 vstatestatus1 ST pl-1 pr-1" style="display:none">
                                                                <label class="col-md-12 pl-1 pr-1 vstatestatus1" style="display:none">Level</label>

                                                                <div class="col-md-12 pl-1 pr-1 vstatestatus1" style="display:none">
                                                                    <select id="vStatus2021_1" name="vStateStatus[]" onchange="return get_sub(this,1);" class="vstatestatus1">
                                                            ...
                                                            <div class="form-group col-md-3 VAC pl-1 pr-1" style="display:none">
                                                                ...
                                                                <div class="col-md-12 pl-1 pr-1">
                                                                    <select class="form-select VAC1" onchange="return getstatus(this,1);" name="vstatus[]" id="vstatus1">
                                                                        <option value="">Select Status</option>
                                                    ...
                                                    <option value="FV">Forest Village</option> -->
                                                            ...
                                                            <div class="form-group col-md-3 pl-1 pr-1 statestatus1 ST" style="display:none">
                                                                <label class="col-md-12 pl-1 pr-1 statestatus1" style="display:none">Status</label>
                                                            ...
                                                            <div class="form-group col-md-2 ORR pl-1 pr-1" id="checkhide">
                                                                ...
                                                                <div class="col-md-12 pl-1 pr-1">
                                                                    ...
                                                                    <input type="checkbox" onchange="return gettext_data(this,'');" id="oremovenew" name="oremovenew[]" class="oremovenew" value="1"><label class="pl-2" for="oremove1">With New Name</label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group col-md-3 ORRN pl-1 pr-1">
                                                                ...
                                                                <div class="col-md-12 pl-1 pr-1">
                                                                    <input type="text" data-parsley-minlength="2" class="form-control newnamecheck" data-parsley-pattern="^[^<>;]+$" data-parsley-pattern-message="'<' OR '>' value seems to be invalid." name="newnamecheck[]" placeholder="Enter New Name" id="newnamecheck">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-2 mt-1" id="addbtut">
                                                            <button type="button" disabled class="btn btn-primary btn-rounded waves-effect waves-light add_button_name">
                                                                <i class="fas fa-plus-circle mr-1"></i>
                                                                <span>ADD </span>
                                                            </button>
                                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary btn-rounded waves-effect width-xl closepop1 closepopup" data-dismiss="modal" aria-label="Close">Cancel</button>
                    ...
                    <div id="alreadydocument" class="modal fade bs-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" data-keyboard="false" data-backdrop="static" aria-hidden="true">
                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <form class="form-horizontal group-border-dashed parsley-examples" id="olddocumentselect">
                                    ...
                                    <div class="modal-header bg-primary">
                                        <h5 class="modal-title text-white" id="maintitle">The Document you are trying to upload may already Exist. Please Verify...</h5>
                                        <!--  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button> -->
                                    </div>
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-xl-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <table id="alreadydoc-datatable" class="table table-hover table-striped table-bordered nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                            <thead>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-secondary waves-effect" onclick="newdocumentadded();">New</button>
                                        <button type="submit" name="submit" class="btn btn-info waves-effect waves-light">Continue</button>
                                        <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal" aria-label="Close">Cancel</button>
                                    </div>
                                </form>
                    ...
                    <div id="submergedocument" class="modal fade bs-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" data-keyboard="false" data-backdrop="static" aria-hidden="true">

                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <form class="form-horizontal group-border-dashed" data-parsley-validate novalidate data-parsley-trigger="keyup" id="submergedata">
                                                ...
                                                <div>
                                                    ...
                                                    <div style="display:none;" id="ststatussub">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9 pt-2">
                                                                <select id="stategetsub" onchange="return get_district_popup_list(this);" name="stategetsub[]">
                                                    ...
                                                    <div style="display:none;" id="districtstatussub">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9 pt-2">
                                                                <select id="districtgetsub" onchange="return get_district_popup_sublist(this);" name="districtgetsub[]">
                                                    ...
                                                    <div style="display:none;" id="subdistrictstatussub">
                                                        <div class="form-group row">
                                                            <label class="col-md-3 col-form-label">Select Sub-District</label>
                                                            <div class="col-md-9 pt-2">
                                                                <select id="subdistrictgetsub" onchange="return get_sub_district_popup_list(this);" name="subdistrictgetsub[]">
                                                                    <option value="">Select Sub-District</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-2 mt-1" id="addbtut">
                                                        <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light add_button_name">
                                                            <i class="fas fa-plus-circle mr-1"></i>
                                                            <span>ADD </span>
                                                        </button>
                                                    </div>
                    ...
                    <div id="con-link-document" class="modal fade bs-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" data-keyboard="false" data-backdrop="static" aria-hidden="true">
                            ...
                            <div class="modal-content" style="flex-direction: unset;">
                                ...
                                <form class="form-horizontal group-border-dashed parsley-examples" id="reusedoc">
                                    ...
                                    <div class="modal-body" style="padding: 0rem;">
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <table id="alreadydoc-datatable-list" class="table table-hover table-striped table-bordered" style=" border-collapse: collapse; border-spacing: 0; width: 100%;"> <br />
                                                            <thead>
                                                                <tr>
                                                                <tr>
                                                                    <th colspan="9" style=" text-align: center; background-color: #5D6D7E; color: white; font-size:20px">Original Document Information</th>
                                                                    <th colspan="3" style=" text-align: center; background-color: #34495E; color: white; font-size:20px">Reused Document Information</th>
                                                                    <th colspan="1" style=" text-align: center; background-color: #5D6D7E; color: white; font-size:15px">Document Status</th>
                                                                    <th colspan="1" style="text-align: center; background-color: #34495E; color: white; font-size: 15px"></th>
                                                                </tr>
                                                                </tr>
                                                                ...
                                                                <th style="background-color: #5D6D7E; color: white ">Used By</th> <!--modified by sahana JC_22 -->
                                                                <th style="background-color: #5D6D7E; color: white ">Used On</th> <!--modified by sahana JC_22 -->
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-info waves-effect waves-light" onclick="selecteddocumentrow();" id="reuseBtn" disabled>Reuse</button>
                                        <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal" aria-label="Close" onclick="refreshPage()">Cancel</button>
                                ...
                                <div id="myModal" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content" id="popup1" style="position: absolute;top: 410px;left: 220px;transform: translate(-50%, -50%);cursor: move;">
                                                ...
                                                <div class="card-body">
                                                    <form id="reusedescription" method="POST" action="">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="doc_reuse_desc" required oninput="validatedoc_reuse_desc(this)" name="doc_reuse_desc" placeholder="Enter Reused Document Description" data-parsley-pattern="^[^<>;]+$" data-parsley-pattern-message="'<' OR '>' value seems to be invalid." onkeypress="return validatereusedescriptionn(event)" required data>
                                                            <div id="error" class="error-message" style="color:red ;font-size: 0.78rem;"></div>
                                                        ...
                                                        <button type="button" class="btn btn-secondary waves-effect" aria-label="Close" style="float:right" onclick="deselectCheckbox()">Cancel</button>
                                                        <button type="submit" class="btn btn-primary" style="float:right; margin-right:3px" onclick="enableReuse()">Save</button>
                        ...
                        $(document).ready(function() {
                            ...
                            $('#reusedescription').submit(function(e) {
                                ...
                                $.ajax({
                                    ...
                                    url: "insert_data.php",
                                    data: {
                                        doc_reuse_desc: inputValue,
                                        formname: "finaladddoc"
                                    },
                    ...
                    <div id="remarks_all_hist" class="modal fade bs-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" data-keyboard="false" data-backdrop="static" aria-hidden="true">

                        <div class="modal-dialog modal-xl">
                            <div class="modal-content" id="popup2" style="position: absolute;top: 410px;left: 410px;transform: translate(-50%, -50%);cursor: move;">
                                ...
                                <form class="form-horizontal group-border-dashed parsley-examples" id="reusedoc">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-xl-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <table id="remarks-datatable-list" class="table table-hover table-striped table-bordered nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                            <thead>
                                                                <tr>
                                                                    <th>Remarks</th>
                                                                    <th>Date And Time</th>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal" aria-label="Close">Close</button>
                                    </div>
                                </form>
                    ...
                    <div id="con-close-modal-add123" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">

                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <form enctype="multipart/form-data" class="form-horizontal group-border-dashed" data-parsley-validate novalidate data-parsley-trigger="keyup" id="adduser">
                                            ...
                                            <div class="col-xl-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 pt-2">
                                                        ...
                                                        <select data-toggle="select1" required id="userType" name="userType" onchange="updateDropdown(this)">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 pt-2">
                                                        ...
                                                        <select data-toggle="select2" <?php if ($_GET['come'] == 'comefromdocadd') { ?> disabled <?php } ?> required id="addSTID2021" name="addSTID2021" onchange="return get_dist_select_data(this,'<?php echo $passvalue; ?>');">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input class="form-control" type="text" id="username" name="username" value="" placeholder="Enter Officer's  Name" data-parsley-pattern="^[a-zA-Z.\s]+$" data-parsley-pattern-message="Officer's Name can contain only alphabets and spaces." data-parsley-minlength="3" data-parsley-maxlength="25" style="width: 328%;" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input class="form-control" type="text" id="adddesignation" name="adddesignation" value="" placeholder="Enter Officer's Designation" data-parsley-pattern="^[^<>]+$" data-parsley-pattern-message="Designation can contain only alphabets and spaces." data-parsley-minlength="3" data-parsley-maxlength="25" style="width: 328%;" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input class="form-control" type="number" id="addmobile" name="addmobile" value="" placeholder="Enter Mobile Number" data-parsley-minlength="1" data-parsley-maxlength="10" onkeypress="return validate(event)" data-parsley-pattern="^[6-9][0-9]{9}$" data-parsley-pattern-message="Invalid Mobile Number  OR  Mobile Number length should be 10" style="width: 328%;" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input class="form-control" type="text" id="addemail" name="addemail" value="" placeholder="Enter Email " data-parsley-minlength="3" data-parsley-pattern="^[a-z](?:[a-z0-9_.-]*[a-z0-9])?$" data-parsley-pattern-message="Email ID is invalid" required> <br>

                                                    </div>

                                                    <div class="col-md-1 col-form-label">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" id="email1" name="emailType" value="@nic.in" checked>
                                                            <label class="form-check-label" for="email1">@nic.in</label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" id="email2" name="emailType" value="@gov.in">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <input type="password" autocomplete="new-password" class="form-control" name="addpassword" data-parsley-length="[13, 16]" data-parsley-uppercase="1" data-parsley-lowercase="1" data-parsley-number="1" data-parsley-special="1" data-parsley-pattern="^(?=[^\W_])(?!.*[\W_ ]$).*$" data-parsley-pattern-message="Password should not begin or end with special characters or spaces." id="addpassword" required placeholder="Enter Password" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9" style="position:relative;">
                                                        <input class="form-control" autocomplete="off" type="password" data-parsley-equalto="#addpassword" data-parsley-required="true" id="ncpassword" name="ncpassword" value="" data-parsley-length="[13, 16]" placeholder="Enter Confirm password" required>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary waves-effect closepop" data-dismiss="modal" onclick="refreshPage()">Cancel</button>
                    ...
                    <div id="resetcon-close-modal" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">

                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <form enctype="multipart/form-data" class="form-horizontal group-border-dashed parsley-examples" id="resetupdateusers">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9" style="position:relative;">
                                                        <input class="form-control" type="password" data-parsley-required="true" id="npassword" autocomplete="off" name="npassword" value="" data-parsley-length="[13, 16]" data-parsley-uppercase="1" data-parsley-lowercase="1" data-parsley-number="1" data-parsley-special="1" placeholder="Enter password" required>
                                    ...
                                    top: 10px;">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <label class="col-md-3 col-form-label">Confirm Password</label>
                                                    <div class="col-md-9" style="position:relative;">
                                                        <input class="form-control" autocomplete="off" type="password" data-parsley-equalto="#npassword" data-parsley-required="true" id="cpassword" name="cncpassword" value="" data-parsley-length="[13, 16]" placeholder="Enter Confirm password" required>
                                                        <div style="z-index: 9999;
                                                width: fit-content;
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary waves-effect closepop" data-dismiss="modal" onclick="resetModal()">Cancel</button>
