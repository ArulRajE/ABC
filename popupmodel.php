                                                ...
                                                <div style="display:none;" id="ststatussub">
                                                    ...
                                                    <div id="adddataofsub">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <textarea class="form-control sub-remark" required placeholder="Remark" rows="4" name = "remarksubmerge[]" id="remarksubmerge"></textarea>
                                                            </div>
    ...
    $('#myModal').on('hidden.bs.modal', function () {
        enableReuse();
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input class="form-control" type="text" id="username" name="username" value=""
                                                                placeholder="Enter Officer's  Name"data-parsley-pattern="^[a-zA-Z.\s]+$" data-parsley-pattern-message="Officer's Name can contain only alphabets and spaces." data-parsley-minlength="3" data-parsley-maxlength="25" style="width: 328%;" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input class="form-control" type="text" id="adddesignation" name="adddesignation" value=""
                                                                placeholder="Enter Officer's Designation"data-parsley-pattern="^[^<>]+$" data-parsley-pattern-message="Designation can contain only alphabets and spaces." data-parsley-minlength="3" data-parsley-maxlength="25" style="width: 328%;" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input class="form-control" type="number" id="addmobile" name="addmobile" value=""
                                                                placeholder="Enter Mobile Number" data-parsley-minlength="1" data-parsley-maxlength="10" onkeypress="return validate(event)" data-parsley-pattern="^[6-9][0-9]{9}$" data-parsley-pattern-message="Invalid Mobile Number  OR  Mobile Number length should be 10"style="width: 328%;" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input class="form-control" type="text" id="addemail" name="addemail" value=""
                                                                placeholder="Enter Email " data-parsley-minlength="3" data-parsley-pattern="^[a-z](?:[a-z0-9_.-]*[a-z0-9])?$" data-parsley-pattern-message="Email ID is invalid" required> <br>
                    ...
                    <div class="form-group row">
                                    ...
                                    data-dismiss="modal" onclick="refreshPage()">Cancel</button>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <form enctype="multipart/form-data" class="form-horizontal group-border-dashed parsley-examples"
                                                    ...
                                                    <div class="col-md-9" style="position:relative;">
                                                        <input class="form-control" type="password"  data-parsley-required="true"
                                                            ...
                                                            data-parsley-length="[13, 16]"  
                                                                                                    ...
                                                                                                    data-parsley-lowercase="1"
                                                                                                    data-parsley-number="1"
                                                                                                    data-parsley-special="1" placeholder="Enter password" required>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary waves-effect closepop"
                                            data-dismiss="modal" onclick="resetModal()">Cancel</button>
