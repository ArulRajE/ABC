                                ...
                                <div class="card table-responsive">
                                    <div class="card-body">
                                       <!--  <div class="dropdown float-right">
                                        ...
                                        <h4 class="header-title mb-4">Town Wise Administrative Units Information 2021</h4>
                                        
                                        <table id="2021alltown-units-datatable" class="table table-hover table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th>State Name</th>
                                                    <th>District Name</th>
