...
$(document).ready(function() {
  $(document).on('click', '.dropdown-item', function() {
    ...
    if (selectedYear == '2011' || selectedYear == '2021' || selectedYear == '2011-2021') {
      ...
      if (selectedYear == '2011') 
      {
        columns = ["Village/Town MDDS Code", "Village/Town Name", "Level", "Civic Status", "Population"];
      } 
      else if (selectedYear == '2021') 
      {
        columns = ["Village/Town MDDS Code", "Village/Town Name", "Level", "Civic Status", "Population", "Status"];
      } 
      else if (selectedYear == '2011-2021') 
      {
        columns = [
            "Village/Town MDDS Code 2011", "Village/Town Name 2011", "Level 2011", "Civic Status 2011", "Population 2011",
            "Village/Town MDDS Code 2021", "Village/Town Name 2021", "Level 2021", "Civic Status 2021", "Population 2021", "Status 2021"
        ];  
      }
      ...
      for (var j = 0; j < dataRows.length; j++) {
        ...
        for (var k = 0; k < columns.length; k++) {
          if (selectedYear == '2021') 
          {
            var originalIndex = k + 5; 
            rowDataObj[columns[k]] = rowData[originalIndex].textContent.trim();
          } else if (selectedYear == '2011')
          {
            rowDataObj[columns[k]] = rowData[k].textContent.trim();
          }
          else if (selectedYear == '2011-2021') 
          {
            if (k > 5 && rowData[k].classList.contains('class2021')) {
                rowDataObj[columns[k]] = rowData[k].textContent.trim();
            } else {
                rowDataObj[columns[k]] = rowData[k].textContent.trim();
            }
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                    ...
                                    if($data2['auaction']== 'Split'){
                                        ...
                                        else if ($data['SDID']==$data2['SDID'] && $STIDDATA[1]!=$data['SDID'] && $data['SDID2011']!=$data['SDID'] && $STIDDATA[1]!=$data['SDID'] && $data['SDID2011']==$data['SDID']) //0211  0611 && $STIDDATA[1]==$data['SDID'] //0412 && $data['SDID2011']==$data['SDID']
                                        {
                                            echo $data['MDDS_VT'.$_SESSION['logindetails']['baseyear'].'']; 
                                        }
                                        else if ($data['SDID']==$data2['SDID'] && $STIDDATA[1]!=$data['SDID'] && $data['SDID2011']!=$data['SDID'] && $data['DTID']!=$data2['DTID']) //0211  0611 && $STIDDATA[1]==$data['SDID'] //0412 && $data['DTID']!=$data2['DTID']
                                        {
                                            echo ""; 
                                        }
                                        ...
                                        else if ($data['STID2011']==$data['STID'] && $data['DTID2011']!=$data['DTID'] && $data['SDID2011']!=$data['SDID'] && $data['STID']==$data2['STID'] && $data['DTID']==$data2['DTID'] && $data['SDID']==$data2['SDID'] && $STIDDATA[4]!=$data2['DTID'] && $STIDDATA[1]==$data['SDID2011']) //2612
                                        {
                                            echo $data['MDDS_VT'.$_SESSION['logindetails']['baseyear'].'']; 
                                        }
                                        else if ($data['STID2011']==$data['STID'] && $data['DTID2011']==$data['DTID'] && $data['SDID2011']!=$data['SDID'] && $data['STID']==$data2['STID'] && $data['DTID']==$data2['DTID'] && $data['SDID']==$data2['SDID'] && $STIDDATA[4]==$data2['DTID'] && $STIDDATA[1]==$data['SDID2011']) //0101
                                        {
                                            echo $data['MDDS_VT'.$_SESSION['logindetails']['baseyear'].'']; 
                                        }
                                        else 
                                        ...
                                        else if ($data['SDID2011']!=$data['SDID'] && $STIDDATA[4]!=$data['DTID'] && $data['STID']==$STIDDATA[7]  && $STIDDATA[4]==$data2['DTID']) //2712
                                        {
                                            echo $data['MDDS_VT'.$_SESSION['logindetails']['baseyear'].'']; 
                                        }
                                        else if ($data['DTID2011']==$data['DTID'] && $STIDDATA[1]!=$data2['SDID'] && $data['SDID2011']!=$data['SDID'] && $data['STID2011']==$data['STID']) //0311 //2112
                                        {
                                            echo $data['MDDS_VT'.$_SESSION['logindetails']['baseyear'].'']; 
                                        }
                                        else if ($data['STID2011']==$data['STID'] && $data['DTID2011']!=$data['DTID']  && $data['SDID2011']!=$data['SDID'] && $data['STID']==$data2['STID'] && $data['DTID']==$data2['DTID'] && $data['SDID']==$data2['SDID'] && $data['SDID2011']==$STIDDATA[1] && $STIDDATA[4]==$data['DTID2011']) //0101
                                        {
                                            echo $data['MDDS_VT'.$_SESSION['logindetails']['baseyear'].'']; 
                                        }
                                        else {
                                    ...
                                    {
                                        if($data['STID2011']!=$data2['STID'] && $data['DTID2011']!=$data['DTID'] && $data['SDID2011']!=$data['SDID'] && $data['SDID2011']==$STIDDATA[1] && $data['SDID']==$data2['SDID'] && $data['STID2011']==$STIDDATA[7]) //1212 2112
                                        { 
                                            echo $data['MDDS_VT'.$_SESSION['logindetails']['baseyear'].'']; 
                                        } 
                                    ...
                                    else if ($data2011['auaction'] == 'submerge') //2112
                                    {
                                        if ($data['STID2011']==$data2011['STID'] && $data['DTID2011']==$data2011['DTID'] && $data['SDID2011']==$data2011['SDID'])
                                        {
                                            echo $data['MDDS_VT'.$_SESSION['logindetails']['baseyear'].'']; 
                                        }
                                        else 
                                    ...
                                    else if ($data2011['auaction'] == 'Split') //2112
                                    {
                                        if ($data['STID2011']==$data2011['STID'] && $data['DTID2011']==$data2011['DTID'] && $data['SDID2011']==$data2011['SDID'])
                                        {
                                            echo $data['MDDS_VT'.$_SESSION['logindetails']['baseyear'].'']; 
                                    ...
                                    else if ($data2011['auaction'] == 'Deletion') //2112
                                    {
                                        if ($data['STID2011']==$data2011['STID'] && $data['DTID2011']==$data2011['DTID'] && $data['SDID2011']==$data2011['SDID'])
                                        {
                                            echo $data['MDDS_VT'.$_SESSION['logindetails']['baseyear'].'']; 
