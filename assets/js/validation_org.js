                                    ...
                                    //   alert(seleted);
                                        ...
                                        // JC_02 ends here
                                          ...
                                          $('select[name="namefrom[]"]').change(function() {
                                            ...
                                            // Incomplete Sub district trigger split jc_02
                                            else if(finalresult[3]=='Create')
                                            {
                        ...
                        else
                        {
                           ...
                           //Reshuffle code for village/town modified by Rithisha
                           else if(res[5]=='Reshuffle')
                            {
                                var mainaction = '';  
                                var lableof='';
                                (dataarray['applyon']=='Village / Town')
                                            {
                                                lableof='Village(s) / Town';
                                                 mainaction +='<table class="table table-bordered mb-0 table-hover"><thead><tr class="trhead"><th> Existing - '+lableof+'(s)</th><th> Moved / Reshuffled </th></tr></thead><tbody>';                            
                                            }
                                       ...
                                       //   console.log(dataarray);
                                        ...
                                        {
                                                // var name='';
                                                // if(dataarray['ostate'][k]=='VILLAGE')
                                                // {

                                                //     totalvcount = totalvcount+1;
                                                //    //  name = capitalizeFirstLetter(namefromtext[k]);
                                                //     name = dataarray['namefromtext'];
                                                //     vnames +=name+', ';   
                                                //     vflag ='Village(s)';
                                ...
                                // if(totalvcount!=0 && totaltcount==0)
                                // {
                                // fmsg = '(Total - '+totalvcount+' ) <strong> '+vflag+' - <span class="trinstrong1">'+vnames+'</span></strong> <br> Move / Reshuffle to <br>'+fromnamenew+'';
                                // }
                                // else if(totalvcount==0 && totaltcount!=0)
                                // {

                                // fmsg = '(Total - '+totaltcount+' ) <strong> '+tflag+' - <span class="trinstrong1">'+tnames+'</span></strong>  <br> Move / Reshuffle to <br>'+fromnamenew+'';

                                // }
                                // else
                                // {
                                // fmsg = '(Total - '+totalvcount+' ) <strong> '+vflag+' - <span class="trinstrong1">'+vnames+'</span></strong><br> AND <br> (Total - '+totaltcount+' ) <strong> '+tflag+' - <span class="trinstrong1">'+tnames+'</span></strong>  <br> Move / Reshuffle to <br>'+fromnamenew+'';

                                // }

                                fmsg = '(Total - '+namefromtext.length+' ) <strong> Village(s) / Town(s) - <span class="trinstrong1">'+dataarray['namefromtext']+'</span></strong>  <br> Moved / Reshuffled to <br>'+fromnamenew+'';
                              
                                $('#mainaction').html('');
                                $('#mainaction').html(fmsg);
                                mainaction +='<tr><td><strong class="trinstrong1">'+dataarray['namefromtext']+' <span class="trinspam">Village(s)/Town(s)</span></strong></td><td>'+fromnamenew+'</td></tr>';
                                    ...
                                    for(var k=0;k<returndata['namefrom'].length;k++)
                                                {
                                                        ...
                                                        //modified by sahana to change UI for partially Split and merge in district level summary 
                                                        fromnamenew ='<strong><span class="trinspam">'+sssflag+'</span></strong> <strong class="trinstrong">'+returndata['nametotext']+'</strong>, ';
