    ...
    $("#login_form").submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (data)   // A function to be called if request succeeds
            {
                ...
                //code changed by bheema
                else if (data == 'logged_user') {
                   
                    $("#danger_alert_msg").text("You are already logged in from another device. Try after some time");
                    $("#danger_alert").fadeTo(4000, 500).slideUp(500, function () {
                        $("#danger_alert").slideUp(500);
                    });
                        ...
                        if($('#clickpopup').val()=='Merge' || $('#clickpopup').val()=='Partiallysm')
                        {
                         ...
                         //    console.log(dataarray);
                             ...
                             //    var maintitaldata = '<strong>'+capitalizeFirstLetter(dataarray['namefromtext'])+'</strong> '+dataarray['comefromcheck']+' '+dataarray['action'][0]+'d into <strong>'+capitalizeFirstLetter(dataarray['nametotext'])+'</strong> '+dataarray['comefromcheck']+' And '+dataarray['comefromcheck']+' <strong>'+dataarray['nametotext']+'</strong> name changed to <strong>'+capitalizeFirstLetter(dataarray['newnamecheck'][0])+'</strong>' ;    
                                var aa=capitalizeFirstLetter(dataarray['newnamecheck'][0].toLowerCase());
...
// rename state validation ends here & starts for village
                        ...
                        {        
                                    ...
                                    {   
                                        ...
                                        if(dataarray['vlevel'][k]==dataarray['vStateStatus'][k])
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                fl = '<strong class="trinstrong">'+capitalizeFirstLetter(dataarray['vStateStatus'][k])+' - '+dataarray['vstatus'][k]+'</strong>';                                               
                                            }
                                        ...
                                        var hh='<strong class="trinstrong">'+capitalizeFirstLetter(dataarray['newnamecheck'][k])+' </strong>';
                                        }
                                        else
                                        {
                                    ...
                                    else
                                    {
                                        ...
                                        // fmsg +=  " <ol>(Total - " + totalvcount + " ) <strong> " + vflag + ' - <span class="trinstrong1">' +toname[k]+ "</span></strong>  Renamed as " +  fromnamenew + " </ol>";
                                         mainaction +='<tr><td><strong class="trinstrong1">'+toname[k]+' <span class="trinspam">('+dataarray['applyon']+')</span></strong></td><td><strong class="trinstrong">'+capitalizeFirstLetter(dataarray['newnamecheck'][k])+' <span class="trinspam">('+dataarray['applyon']+')</span></strong></td></tr>';
                                    }
                                                                        }
  ...
  fmsg = '(Total - 1 ) <strong>New  '+returndata['comefromcheck']+'(s) - <span class="trinstrong1">'+capitalizeFirstLetter(returndata['newname'][0])+'</span></strong>  <br> Created from <br><strong><span class="trinspam">'+returndata['comefromcheck']+'(s) :</span></strong> '+fromnamenew+'&nbsp;Using Full Merge Action';
                             ...
                             else
                             {
                                   ...
                                   namefromtext = returndata['namefromtext'].split(',');
                                    ...
                                    fmsg = '(Total - 1 ) <strong>New  '+returndata['comefromcheck']+'(s) - <span class="trinstrong1">'+capitalizeFirstLetter(returndata['newname'][0])+'</span></strong>  <br> Created from <br><strong><span class="trinspam">'+returndata['comefromcheck']+'(s) :</span></strong> '+fromnamenew+'';
    ...
    if($('#clickpopup').val()=='Merge' || $('#clickpopup').val()=='Partiallysm')
       {
               ...
               dataarray['namefrom'] = dataarray['namefromtext'].split(',');
                   ...
                   if (dataarray['action'] == 'Merge' || dataarray['action'] == 'Partially Merge') {
                       if (resArray[0][k]['Level'] == 'VILLAGE') {//modified by sahana 0509
                           ...
                           name = capitalizeFirstLetter(dataarray['nametotext']);
        ...
        {
          //modified by sahana status merge village
          fmsg = fmsg+' <br> AND <br> <strong><span class="trinspam"></strong></span>' + fromnamenew +' name changed to <strong class="trinstrong">'+capitalizeFirstLetter(dataarray['newnamecheck'][0])+ '<span class="trinspam"> (' + vs + ' - ' + dataarray['vstatus'] + ')</span></strong>'; //modified by sahana JC_41                 
        }  
           ...
           return false;
                        ...
                        else if($('#clickpopup').val()=='Rename')
                        {
                              ...
                              for(var k=0;k<dataarray['newnamecheck'].length;k++)
                              {
                                    ...
                                    main +=' <strong>'+capitalizeFirstLetter(toname[k])+'</strong> '+dataarray['comefromcheck']+' Rename as <strong>'+capitalizeFirstLetter(dataarray['newnamecheck'][k])+'</strong> and';
                              }
                                    ...
                                    //   console.log(dataarray);
                                        ...
                                        for(var k=0;k<dataarray['newname'].length;k++)
                                        {
                                                ...
                                                if(dataarray['vStateStatus'][k]=='VILLAGE')
                                                {
                                                    ...
                                                    totalvcount = totalvcount+1;
                                                    name = capitalizeFirstLetter(dataarray['newname'][k]);
                            ...
                            if (dataarray['flag'] === 'newname' && dataarray['newname'] !== null && Array.isArray(dataarray['newname']) && dataarray['newname'].length > 1 && 'namefrom' in dataarray && dataarray['namefrom'].length === 1)
                                {
                                    ...
                                    for (var k = 0; k < dataarray['newname'].length; k++) {
                                        ...
                                        var name = capitalizeFirstLetter(dataarray['newname'][k]);
                                        if (dataarray['vStateStatus'][k] == 'VILLAGE') {
                                            totalvcount = totalvcount + 1;
                                ...
                                else if(dataarray['flag']=='newname')
                                {
                                    ...
                                    var name = capitalizeFirstLetter(dataarray['newname'][0]);
                       ...
                       if(returndata.hasOwnProperty('flag'))
                        {
                                            ...
                                            if(returndata['flag']=='namefrom')
                                            {
                                                    ...
                                                    for(var k=0;k<returndata['namefrom'].length;k++)
                                                        ...
                                                        {
                                                            totalstcount = 1;
                                                             stmsgname =capitalizeFirstLetter(returndata['newname'][0])+', ';
                                                       ...
                                                       //  mainaction +='<tr class="trleftalign"><td><strong><span class="trinstrong1">'+returndata['newname'][0]+'</span><span class="trinspam">'+sssflag+'</span></strong></td><td>'+fromdatacoccatename+'</td><td>'+fromdatacoccatenamep+'</td></tr>';
                                                        ...
                                                        {
                                                            //modified by sahana status split district 1609
                                                            mainaction +='<tr class="trleftalign"><td><strong><span class="trinspam">'+dataarray['applyon']+': </span><span class="trinstrong1">'+capitalizeFirstLetter(returndata['newname'][0])+'</span></strong></td><td>'+fromdatacoccatename+'</td><td>'+fromdatacoccatenamep+'</td></tr>';
                                                        }
                                            ...
                                            else
                                            {
                                                ...
                                                for(var k=0;k<returndata['newname'].length;k++)
                                                {
                                                        ...
                                                        {
                                                             totalstcount = totalstcount+1;
                                                             stmsgname +=capitalizeFirstLetter(returndata['newname'][k])+', ';
                                                             var flagof = '';
                                                             if(dataarray.hasOwnProperty('partiallylevel'+k+''))
                                                             {  //modified by sahana status split district 1609
                                                                 flagof +='<strong class="trinstrong"><span class="trinspam">'+dataarray['applyon']+': </span>'+namefromtext[0]+'</strong> - '+dataarray['addpartiallyleveltext'+k+''].replaceAll(",", ", ")+'';
                                                                 // flagof +='<strong class="trinstrong">'+namefromtext[0]+'<span class="trinspam">('+dataarray['applyon']+')</span></strong> - '+dataarray['addpartiallyleveltext'+k+''].replaceAll(",", ", ")+'';
                                                                  ...
                                                                  fromnamenew ='<strong class="trinstrong">'+capitalizeFirstLetter(namefromtext[0])+'</strong>, ';
                                                           
                                                                  //modified by sahana status split district 1509
                                                                  mainaction +='<tr class="trleftalign"><td><strong><span class="trinspam">'+dataarray['applyon']+': </span><span class="trinstrong1">'+capitalizeFirstLetter(returndata['newname'][k])+'</span></strong></td><td><strong class="trinstrong">';
                                                               if(dataarray['addlinksDTIDtext'+k+''].length>0){
								 ...
								 //2009
                                        ...
                                        toStatus = 'State'; 
                                          ...
                                          if(dataarray['applyon']=='State')
                                          {
                                               ...
                                               mainaction +='<tr class="trleftalign"><td><strong>'+toStatus+': <span class="trinstrong1">'+capitalizeFirstLetter(nameflag)+'</span>&nbsp<span class="trinspam">'+toflag+'</span></strong></td><td>'+fromdatacoccatename.replaceAll(",", ", ")+'</td><td>'+fromdatacoccatenamep.replaceAll(",", ", ")+'</td></tr>';      
                                          }
                                          else
                                          {
                                              //modified by sahana to change Partially merge table summary 01-08-2023
                                              mainaction +='<tr class="trleftalign"><td><strong><span class="trinspam">'+dataarray['applyon']+': </span><span class="trinstrong1">'+capitalizeFirstLetter(nameflag)+'</span></strong></td><td>'+fromdatacoccatename.replaceAll(",", ", ")+'</td><td>'+fromdatacoccatenamep.replaceAll(",", ", ")+'</td></tr>'; 
                                          }
                                            ...
                                            if(returndata['oremovenewarray']=='1')
                                            {
                                                if(returndata['StateStatus'][0]=='ST')
                                                  ...
                                                  else if(returndata['StateStatus'][0]=='UT')
                                                  {
                                                                        ...
                                                                        fmsg = fmsg+' <br> AND <br> '+ fromnamenew+' name changed to <strong class="trinstrong">'+capitalizeFirstLetter(returndata['newnamecheck'][0])+'</strong> <strong><span class="trinspam">('+returndata['comefromcheck']+')</span></strong>'; //modified by sahana status merge state 1509
                                            }
