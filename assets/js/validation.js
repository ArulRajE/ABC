        ...
        data: "formname=getdataofpopupsub_sublist&comefrom=" + seleted +"&clickpopup="+clickpopup+"&fstids=" + fstids+"&fdtids=" + fdtids+"&fsdids=" + fsdids+"&tstids=" + tstids+"&tdtids="+tdtids+"&tsdids="+tsdids
         ...
         var finalresult = result.split("|");
                    ...
                    {  
                            ...
                            $("#subdistrictgetsub"+i).children().remove();
                            $("#subdistrictgetsub"+i).append($('<option>', {
                            value: '',
                            text: 'Select Sub-District',
                            }));
                            // $("#action1,#actiona2").children().remove();
                            ...
                            $('#subdistrictgetsub'+i).val('').trigger('change');
                            //Submerge Dropdown village issue by Pavithra
                            // $('#addbtu,#adddataof,#let').css("display", "block"); 
                            //$('#addbtu,#adddataof,#let').css("display", "none"); 
...
{
        // $('#addbtu,#adddataof,#let').css("display", "none");
        $('#subdistrictgetsub'+i).val('').trigger('change');// // to refresh submerge dropdown added by srikanth
}
...
console.log(finalresult);
    ...
    console.log('i',i);
                            ...
                            $("#districtgetsub"+i).children().remove();
                            $("#districtgetsub"+i).append($('<option>', {
                            value: '',
                            text: 'Select District',
                            }));
                            // $("#action1,#actiona2").children().remove();
                            ...
                            $('#districtgetsub'+i).val('').trigger('change');
                            // $('#addbtu,#adddataof,#let').css("display", "none"); 
...
{
        // $('#addbtu,#adddataof,#let').css("display", "none");
        $('#districtgetsub'+i).val('').trigger('change');// // to refresh submerge dropdown added by srikanth
}
...
} else if($('#applyon').val() == "State" && $('#clickpopup').val() == "Rename"){
...
// rename state validation ends here & starts for village
                        ...
                        {        
                                    ...
                                    {   
                                        ...
                                        if(dataarray["newnamecheck"][k]!='' && dataarray['vstatus'][k] == dataarray['ovstatus'][k])
                                        {//rename
                                        //    fmsg +=" <ol>(Total - " + totalvcount + " ) <strong> " +  vflag + ' - <span class="trinstrong1">'   +toname[k]+ "</span></strong>  Renamed as "  +hh+ "</span></strong>";
                                        }else if (dataarray['vstatus'][k] != dataarray['ovstatus'][k] &&  dataarray["newnamecheck"][k]=='')
                                        {//status change
...
// });
    ...
    $("#adddocumentnext").submit(function (e) {
        ...
        if(dataarray.hasOwnProperty('flag'))
                        {
                                ...
                                namefromtextArray.push(namefromtext);
                                        var namefromtextp='';
                               ...
                               myArray = namefromtext.filter( ( el ) => !namefromtextp.includes( el ) );
                                ...
                                alertflag = namefromtextArray.every(function (subArray) {
                        ...
                        else
                        {
                            ...
                            // Assuming alertflag is initially false
                            var alertflag = false;
                        
                            // Iterate through each select element with id starting with addlinksDTID_
                            $('select[id^="addlinksDTID_"]').each(function() {
                                var selectValue = $(this).val();
                        
                                // Check if the value is null or empty
                                if (selectValue === null || selectValue.length === 0) {
                                    // If any select element has null or empty value, set alertflag to false and break the loop
                                    alertflag = false;
                                    return false; // Break the loop
                                } else {
                                    // If the current select element has a non-null value, set alertflag to true
                                    alertflag = true;
                                }
                            });
                        
                            // Use alertflag as needed, for example, log it to console
    ...
    else
     {
        ...
        if((tempflag==true && addlinksDTID.length == 1)){
